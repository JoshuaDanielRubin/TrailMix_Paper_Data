...
special_nodes += [
    'Node6237', 'MT576653', 'Node6236', 'MT576651', 'U5a2a1b1'
                 ]


pub_special_nodes = [
    "A5b1c1", "B5b1c1", "B6a1", "CZ", "D4a3a", "Denisova2", "Denisova20", "Denisova8", 
    "E1a2a3", "F2a1", "G1a1a4", "HV0c", "HV2a1*1", "HV4b", "I1a1a1", "K1a11b", "L0a3", 
    "L0d2b1a1a", "L0d3a", "L1b", "L1c5", "L2a1d", "L3a", "L3b1a11", "L3c", "L3d1a1b", 
    "L3e1a1", "L3f1b4c", "L3h1b1a", "L4b2a2", "L5a1a", "L5b1a", "L6a", "M21b1", "M5a2a1", 
    "M68a", "M9a1a1c1b1a1", "N11a1", "N3a", "N7a1", "N8", "N9a2a1", "O1a", "P9a", 
    "Q1e1b", "R0a1a1", "R12", "R2b1", "S1a", "S3", "T1a1a1", "U2a1a", "U4b1b1", 
    "U6a6a", "U7a4", "V2a1a", "W3a1a", "X2c1b", "Y1b", "Z4a1a1", "homo_heidel", 
    "Neanderthal_Hohlenstein", "Neanderthal_Lescottes", "Neanderthal_Siberia", 
    "Neanderthal_Stajnia"
                    ]
...
def visualize_tree_branches(tree, source_clades, source_names, branch_iterations, output_file, title_suffix, special_nodes, max_labels=120, no_pruning=False):
    ...
    if len(source_names) > 1:  # Only create and display legend if there are multiple sources
        ...
        if no_pruning:
            # Place legend in the center if no pruning
            plt.legend(handles=legend_handles,
                       labels=modified_source_names, loc='center', fontsize=20, title_fontsize='20')
        else:
            plt.legend(handles=legend_handles,
                       labels=modified_source_names, loc='lower right', fontsize=20, title_fontsize='20', \
                       bbox_to_anchor=(1, 0), bbox_transform=axes.transAxes)
...
def main():
    ...
    parser.add_argument('--no-pruning', action='store_true', help='Flag to disable pruning of the tree')
    ...
    if args.no_pruning:
        small_tree = original_tree
        special_nodes_to_pass = pub_special_nodes
        print("Pruning is disabled.")
    else:
        small_tree = prune_tree(original_tree, source_clades, internal_nodes, max_nodes=args.max_nodes)
        special_nodes_to_pass = special_nodes

    visualize_tree_branches(small_tree, source_clades, source_names, branch_iterations, args.output_file, args.title_suffix, special_nodes_to_pass, \
                            max_labels=args.max_labels, no_pruning=args.no_pruning)
